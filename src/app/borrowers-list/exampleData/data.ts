...
let me: User = new User('1','FindAir',3,[70,90,51], 'assets/images/avatars/female-avatar-1.png', 100000, '1 000 zł / miesiąc', 'Zdrowie', 'Poznań', ' FindAir chce produkować inhalatory, które są „sprzężone” z aplikacją na smartfony. Dzięki takiemu skorelowaniu hardware i software, aplikacja ma zbierać informacje o tym, kiedy i w jakich okolicznościach użytkownik korzystał z inhalatora. FindAir chce produkować inhalatory, które są „sprzężone” z aplikacją na smartfony. Dzięki takiemu skorelowaniu hardware i software, aplikacja ma zbierać informacje o tym, kiedy i w jakich okolicznościach użytkownik korzystał z inhalatora. W aplikacji jest kalendarz pyleń oraz połączenie ze stacjami pomiarowymi, badającymi poziom emisji zanieczyszczeń. Z kolei inhalator – choć jest klasycznym urządzeniem – również posiada dodatkowe funkcjonalności, np. lokalizator pozwalający szybko znaleźć go w kryzysowej sytuacji ');
let ladycap: User = new User('2','Softmicro',1,[17,26,35], 'assets/images/avatars/female-avatar-3.png', 20000, '4 000 zł / 3 miesiące', 'Środowisko', 'Wrocław', 'Oprogramowanie dla użytkowników domowych');
